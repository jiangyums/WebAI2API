...
async function handleDiscordAuth(page) {
    ...
    if (currentUrl.includes("zai.is/auth")) {
        ...
        try {
            ...
            await page.waitForURL((url) => url.href.includes("discord.com/oauth2/authorize"), {
                timeout: 60000
            });
...
async function generate(context, prompt, imgPaths, modelId, meta = {}) {
    ...
    try {
        ...
        try {
            ...
            logger.error("适配器", "解析 chats/new 响应失败", {
                ...meta,
                error: e.message
            });
        ...
        try {
            ...
            logger.error("适配器", "解析 completions 响应失败", {
                ...meta,
                error: e.message
            });
        ...
        try {
            ...
            logger.error("适配器", "解析 chat/completed 响应失败", {
                ...meta,
                error: e.message
            });
...
export const manifest = {
    ...
    models: [
        ...
        },
        {
            ...
            codeName: "Claude Sonnet 4.5",
            imagePolicy: "optional"
        },
        {
            id: "claude-sonnet-4",
            codeName: "Claude Sonnet 4",
            imagePolicy: "optional"
        },
        {
            id: "claude-haiku-4.5",
