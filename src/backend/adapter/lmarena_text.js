...
export const manifest = {
    ...
    description:
        "使用 LMArena 平台生成文本，支持多种大语言模型和搜索模式。需要已登录的 LMArena 账户，若不登录会频繁弹出人机验证码且有速率限制。",
    ...
    models: [
        ...
        { id: "mimo-v2-flash", imagePolicy: "forbidden", type: "text" },
        {
            ...
            codeName: "mimo-v2-flash (thinking)",
            imagePolicy: "forbidden",
            type: "text"
        },
        ...
        { id: "glm-4.7-flash", imagePolicy: "forbidden", type: "text" },
        {
            ...
            codeName: "gemini-3-flash (thinking-minimal)",
            imagePolicy: "optional",
            type: "text"
        },
        ...
        {
            id: "ppl-sonar-reasoning-pro-high",
            imagePolicy: "forbidden",
            type: "text",
            search: true
        },
