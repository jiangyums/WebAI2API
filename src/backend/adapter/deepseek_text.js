...
import { sleep, humanType, safeClick } from "../engine/utils.js";
                        ...
                        try {
                            ...
                            if (
                                ...
                                for (const item of data.v) {
                                    ...
                                    if (
                                        (item.p === "status" || item.p === "quasi_status") &&
                                        item.v === "FINISHED"
                                    ) {
                                        isComplete = true;
                                    }
...
export const manifest = {
    ...
    description:
        "使用 DeepSeek 官网生成文本，支持 DeepThink 深度思考和 Search 搜索模式。需要已登录的 DeepSeek 账户。",
    ...
    models: [
        ...
        {
            id: "deepseek-thinking-expert",
            imagePolicy: "forbidden",
            thinking: true
        },
        { id: "deepseek-search-expert", imagePolicy: "forbidden", search: true },
        {
            id: "deepseek-thinking-search-expert",
            imagePolicy: "forbidden",
            thinking: true,
            search: true
        }
